<?php
/**
 * LOJAEXEMPLOZF_View_Helper_ProductImage
 * 
 ...
 */
class LOJAEXEMPLOZF_View_Helper_ProductImage extends Zend_View_Helper_HtmlElement
{
    /**
     * @var LOJAEXEMPLOZF_Resource_ProductImage_Item
     */
    protected $_image;
     ...
     * productImage
     *
     * @param LOJAEXEMPLOZF_Resource_ProductImage_Item $image
     * @param array $attribs Attributes for the img tag
     * @return Zend_View_Helper_ProductImage
     */
    public function productImage(LOJAEXEMPLOZF_Resource_Productimage_Item $image = null, $attribs = false)
    {
        $this->_image = $image;
