 ...
 */
class LOJAEXEMPLOZF_Model_User extends LOJAEXEMPLOZF_Model_Acl_Abstract
{    
    /**
     * Get User by their id
     * 
     * @param  int $id
     * @return null|LOJAEXEMPLOZF_Resource_User_Item 
     */
     ...
     * @param  LOJAEXEMPLOZF_Resource_User_Item $ignoreUser User to ignore from the search
     * @return null|LOJAEXEMPLOZF_Resource_User_Item 
     */
     ...
     * Delete a user
     *
     * @param int|LOJAEXEMPLOZF_Resource_User_Item_Interface $user
     * @return boolean
     */
    public function deleteUser($user)
    {
        ...
        if ($user instanceof LOJAEXEMPLOZF_Resource_User_Item_Interface) {
