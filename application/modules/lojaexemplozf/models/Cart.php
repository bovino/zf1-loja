 ...
 */
class LOJAEXEMPLOZF_Model_Cart extends LOJAEXEMPLOZF_Model_Abstract implements SeekableIterator, Countable, ArrayAccess
{
   /**
     ...
     *
     * @param LOJAEXEMPLOZF_Resource_Product_Item_Interface $product
     * @param int $qty
     * @return LOJAEXEMPLOZF_Resource_Cart_Item
     */
    public function addItem(LOJAEXEMPLOZF_Resource_Product_Item_Interface $product, $qty)
    {
        if (0 > $qty) {
            return false;
        }
        ...
        $item = new LOJAEXEMPLOZF_Resource_Cart_Item($product, $qty);   
     ...
     * 
     * @param int|LOJAEXEMPLOZF_Resource_Product_Item_Interface $product
     */
    ...
    public function seek($index)
    {
        ...
        if (!$this->valid()) {
            throw new LOJAEXEMPLOZF_Model_Exception('Posição "seek" inválida');
        }
    }
