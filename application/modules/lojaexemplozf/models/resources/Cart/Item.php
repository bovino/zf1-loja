<?php
/**
 * LOJAEXEMPLOZF_Resource_Cart_Item
 *
 ...
 */
class LOJAEXEMPLOZF_Resource_Cart_Item implements LOJAEXEMPLOZF_Resource_Cart_Item_Interface
{
    public $productId;
    public $name;
    public $price;
    ...
    public function __construct(LOJAEXEMPLOZF_Resource_Product_Item_Interface$product, $qty)
    {
