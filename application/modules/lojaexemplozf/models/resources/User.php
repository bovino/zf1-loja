 ...
 */
class LOJAEXEMPLOZF_Resource_User extends LOJAEXEMPLOZF_Model_Resource_Db_Table_Abstract implements LOJAEXEMPLOZF_Resource_User_Interface 
{
    protected $_name = 'user';
    protected $_primary = 'userId';
    protected $_rowClass = 'LOJAEXEMPLOZF_Resource_User_Item';
