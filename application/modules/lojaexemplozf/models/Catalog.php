 ...
 */
class LOJAEXEMPLOZF_Model_Catalog extends LOJAEXEMPLOZF_Model_Acl_Abstract implements Zend_Acl_Resource_Interface
{
    /**
     * @var LOJAEXEMPLOZF_Service_ProductIndexer
     */
    ...
    /**
     * @var LOJAEXEMPLOZF_Model_Document_Product
     */
    protected $_document;
     ...
     * @return LOJAEXEMPLOZF_Resource_Category_Item|null
     */
     ...
     *
     * @param  int $id The id
     * @return LOJAEXEMPLOZF_Resource_Product_Item
     */
     ...
     * 
     * @param LOJAEXEMPLOZF_Resource_Category_Item $category
    ...
    public function saveCategory($data, $validator = null)
    {
        if (!$this->checkAcl('saveCategory')) {
            throw new LOJAEXEMPLOZF_Acl_Exception("Permissões insuficiente");
        }
    ...
    * 
    * @param LOJAEXEMPLOZF_Resource_Product_Item $product
    * @param array $data
    * @param string $validator
    * @return int|false
    */
   public function saveProductImage(LOJAEXEMPLOZF_Resource_Product_Item $product, $data, $validator = null)
    {
        if (!$this->checkAcl('saveProductImage')) {
            throw new LOJAEXEMPLOZF_Acl_Exception("Permissões insuficientes");
        }
    ...
    public function deleteProduct($product)
    {
        ...
        if ($product instanceof LOJAEXEMPLOZF_Resource_Product_Item_Interface) {
...
$this->getIndexer()->deleteProduct($product->productId);
    ...
    {
        if (null === $this->_acl) {
            $this->setAcl(new LOJAEXEMPLOZF_Model_Acl_Storefront());
        }
        return $this->_acl;
    }
    ...
    /**
     * @return LOJAEXEMPLOZF_Service_ProductIndexer
     */
    public function getIndexer()
    {
        if (null === $this->_indexerService) {
            $this->_indexerService = new LOJAEXEMPLOZF_Service_ProductIndexer();
    ...
    /**
     * @param LOJAEXEMPLOZF_Service_ProductIndexer $indexerService 
     */
     ...
     *
     * @param LOJAEXEMPLOZF_Resource_Product_Item $product
     * @return LOJAEXEMPLOZF_Model_Document_Product
     */
    public function createDocument($product)
    {
        if (null === $this->_document) {
            ...
            $this->_document = new LOJAEXEMPLOZF_Model_Document_Product($product, join(',', $categories));
        }
        return $this->_document;
    }

    /**
     * @param LOJAEXEMPLOZF_Model_Document_Product $document
     */
