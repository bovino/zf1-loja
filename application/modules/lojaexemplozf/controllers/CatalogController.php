<?php
class LOJAEXEMPLOZF_CatalogController extends Zend_Controller_Action
{
    /**
     * @var LOJAEXEMPLOZF_Model_Catalog
     */
    ...
    public function indexAction()
    {
        ...
        if (null === $category) {
            throw new LOJAEXEMPLOZF_Exception_404('Unknown category ' . $this->_getParam('categoryIdent'));
        }
    ...
    public function viewAction()
    {
        ...
        if (null === $product) {
            throw new LOJAEXEMPLOZF_Exception_404('Produto desconhecido ' . $this->_getParam('productIdent'));
        }
    ...
    public function productimagesAction()
    {
        ...
        if (false === ($id = $this->_getParam('id',false))) {
            throw new LOJAEXEMPLOZF_Exception('ID de produto nao enviado');
        }

        $product = $this->_catalogModel->getProductById($id);

        if (null === $product) {
            throw new LOJAEXEMPLOZF_Exception('Produto desconhecido');
        }
    ...
    public function saveimageAction()
    {
        ...
        if (false === ($id = $this->_getParam('productId',false))) {
            throw new LOJAEXEMPLOZF_Exception('ID de produto não enviado');
        }
