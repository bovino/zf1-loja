 ...
 */
class LOJAEXEMPLOZF_CustomerController extends Zend_Controller_Action 
{
    protected $_model;
    ...
    public function init()
    {
        ...
        $this->_model = new LOJAEXEMPLOZF_Model_User();
	...
	public function indexAction() 
	{
        ...
        if (null === $this->view->user) {
            throw new LOJAEXEMPLOZF_Exception('Usuário desconhecido');
        }
