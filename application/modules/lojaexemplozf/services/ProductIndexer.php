<?php
/**
 * LOJAEXEMPLOZF_Service_ProductIndexer
 *
 ...
 */
class LOJAEXEMPLOZF_Service_ProductIndexer
{
    /**
    ...
    public function getIndexingEngine()
    {
        if (null === $this->_engine) {
            ...
            if (null === $directory) {
                throw new LOJAEXEMPLOZF_Service_Indexer_Exception('Index directory must be set');
            }
     ...
     */
    public function indexProduct(LOJAEXEMPLOZF_Model_Document_Product $document)
    {
     ...
     * Delete a product
     * 
     * @param LOJAEXEMPLOZF_Model_Document_Product|int $documentOrId 
     */
    public function deleteProduct($documentOrId)
    {
        $id = $documentOrId;

        if ($documentOrId instanceof LOJAEXEMPLOZF_Model_Document_Product) {
     ...
     * 
     * @param LOJAEXEMPLOZF_Model_Catalog $catalogModel 
     */
    public function reIndexAllProducts(LOJAEXEMPLOZF_Model_Catalog $catalogModel)
    {
        ...
        if (null !== $products) {
            foreach ($products as $product) {
                ...
                $document = new LOJAEXEMPLOZF_Model_Document_Product($product, join(',', $categories));
