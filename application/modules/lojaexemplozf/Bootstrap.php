...
class Bootstrap extends Zend_Application_Bootstrap_Bootstrap
{
    ...
    {
        $this->_logger->info('Bootstrap ' . __METHOD__);
        Zend_Controller_Action_HelperBroker::addHelper(new LOJAEXEMPLOZF_Controller_Helper_Acl());
        Zend_Controller_Action_HelperBroker::addHelper(new LOJAEXEMPLOZF_Controller_Helper_RedirectCommon());
        Zend_Controller_Action_HelperBroker::addHelper(new LOJAEXEMPLOZF_Controller_Helper_Service());
    }
    ...
    protected function __handleErrors(Exception $e, $email)
    {
        ...
        if ('' != $email) {
            $mail = new Zend_Mail();
            $mail->setSubject('Erro fatal na aplicação LOJAEXEMPLOZF');
            $mail->addTo($email);
            $mail->setBodyText(
                $e->getFile() . "\n" .
                $e->getMessage() . "\n" .
