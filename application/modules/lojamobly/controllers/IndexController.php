<?php
class LOJAMOBLY_IndexController extends Zend_Controller_Action
{
    ...
    public function searchAction()
    {
        ...
        $searchService = new LOJAMOBLY_Service_Search(
            $this->_catalogModel->getIndexer()
		);
				
        $searcher = new LOJAMOBLY_Service_ProductSearcher(
