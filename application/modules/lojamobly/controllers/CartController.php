 ...
 */
class LOJAMOBLY_CartController extends Zend_Controller_Action
{
    ...
    public function addAction()
    {
        ...
        if (null === $product) {
            throw new LOJAMOBLY_Exception('Não foi possível adicionar o produto ao carrinho porque ele não existe');
        }
