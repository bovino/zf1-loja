 ...
 */
class LOJAMOBLY_CustomerController extends Zend_Controller_Action 
{
    protected $_model;
    ...
    public function init()
    {
        ...
        $this->_model = new LOJAMOBLY_Model_User();
        $this->_authService = new LOJAMOBLY_Service_Authentication();
	...
	public function indexAction() 
	{
        ...
        if (null === $this->view->user) {
            throw new LOJAMOBLY_Exception('Usuário desconhecido');
        }
	...
	public function authenticateAction()
	{
        ...
        if (false === $this->_authService->authenticate($form->getValues())) {
            $form->setDescription('Login falho, tente novamente.');
            return $this->render('login');
        }
