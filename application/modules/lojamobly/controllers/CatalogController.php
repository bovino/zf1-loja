<?php
class LOJAMOBLY_CatalogController extends Zend_Controller_Action
{
    /**
     * @var LOJAMOBLY_Model_Catalog
     */
    ...
    {
        $this->_catalogModel = new LOJAMOBLY_Model_Catalog();
    }
    ...
    public function indexAction()
    {
        ...
        if (null === $category) {
            throw new LOJAMOBLY_Exception_404('Unknown category ' . $this->_getParam('categoryIdent'));
        }
    ...
    public function viewAction()
    {
        ...
        if (null === $product) {
            throw new LOJAMOBLY_Exception_404('Produto desconhecido ' . $this->_getParam('productIdent'));
        }
    ...
    public function productimagesAction()
    {
        ...
        if (false === ($id = $this->_getParam('id',false))) {
            throw new LOJAMOBLY_Exception('ID de produto nao enviado');
        }

        $product = $this->_catalogModel->getProductById($id);

        if (null === $product) {
            throw new LOJAMOBLY_Exception('Produto desconhecido');
        }
    ...
    public function saveimageAction()
    {
        ...
        if (false === ($id = $this->_getParam('productId',false))) {
            throw new LOJAMOBLY_Exception('ID de produto não enviado');
        }
