 ...
 * 
 * @category   Storefront
 * @package    LOJAMOBLY_Model
 * @copyright  Copyright (c) 2008 Keith Pope (http://www.thepopeisdead.com)
 * @license    http://www.thepopeisdead.com/license.txt     New BSD License
 */
class LOJAMOBLY_Model_Catalog extends LOJAMOBLY_Model_Acl_Abstract implements Zend_Acl_Resource_Interface
{
    /**
     * @var LOJAMOBLY_Service_ProductIndexer
     */
    ...
    /**
     * @var LOJAMOBLY_Model_Document_Product
     */
    protected $_document;
     ...
     * @return LOJAMOBLY_Resource_Category_Item|null
     */
     ...
     *
     * @param  int $id The id
     * @return LOJAMOBLY_Resource_Product_Item
     */
     ...
     * @return LOJAMOBLY_Resource_Product_Item|null
     */
    public function getProductBySearch( $data )
    {
   		return $this->getResource('Product')->getProductBySearch( $data );
    }
     ...
     * 
     * @param LOJAMOBLY_Resource_Category_Item $category
    ...
    public function saveCategory($data, $validator = null)
    {
        if (!$this->checkAcl('saveCategory')) {
            throw new LOJAMOBLY_Acl_Exception("Permissões insuficiente");
        }
    ...
    * 
    * @param LOJAMOBLY_Resource_Product_Item $product
    * @param array $data
    * @param string $validator
    * @return int|false
    */
   public function saveProductImage(LOJAMOBLY_Resource_Product_Item $product, $data, $validator = null)
    {
        if (!$this->checkAcl('saveProductImage')) {
            throw new LOJAMOBLY_Acl_Exception("Permissões insuficientes");
        }
    ...
    public function deleteProduct($product)
    {
        ...
        if ($product instanceof LOJAMOBLY_Resource_Product_Item_Interface) {
...
$this->getIndexer()->deleteProduct($product->productId);
     ...
     *
     * @param LOJAMOBLY_Acl_Interface $acl
     * @return LOJAMOBLY_Model_Abstract
     */
    ...
    {
        if (null === $this->_acl) {
            $this->setAcl(new LOJAMOBLY_Model_Acl_Storefront());
        }
        return $this->_acl;
    }
    ...
    /**
     * @return LOJAMOBLY_Service_ProductIndexer
     */
    public function getIndexer()
    {
        if (null === $this->_indexerService) {
            $this->_indexerService = new LOJAMOBLY_Service_ProductIndexer();
    ...
    /**
     * @param LOJAMOBLY_Service_ProductIndexer $indexerService 
     */
     ...
     *
     * @param LOJAMOBLY_Resource_Product_Item $product
     * @return LOJAMOBLY_Model_Document_Product
     */
    public function createDocument($product)
    {
        if (null === $this->_document) {
            ...
            $this->_document = new LOJAMOBLY_Model_Document_Product($product, join(',', $categories));
        }
        return $this->_document;
    }

    /**
     * @param LOJAMOBLY_Model_Document_Product $document
     */
