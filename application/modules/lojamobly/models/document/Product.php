<?php
/**
 *  LOJAMOBLY_Model_Document_Product
 *
 * A product document used in the Lucene index
 *
 * @category   Storefront
 * @package    LOJAMOBLY_Model_Document
 * @copyright  Copyright (c) 2008 Keith Pope (http://www.thepopeisdead.com)
 * @license    http://www.thepopeisdead.com/license.txt     New BSD License
 */
class LOJAMOBLY_Model_Document_Product extends Zend_Search_Lucene_Document
{
    public function  __construct(LOJAMOBLY_Resource_Product_Item_Interface $item, $category)
    {
