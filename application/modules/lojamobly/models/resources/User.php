 ...
 */
class LOJAMOBLY_Resource_User extends LOJAMOBLY_Model_Resource_Db_Table_Abstract implements LOJAMOBLY_Resource_User_Interface 
{
    protected $_name = 'user';
    protected $_primary = 'userId';
    protected $_rowClass = 'LOJAMOBLY_Resource_User_Item';
