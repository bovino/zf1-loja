 ...
 */
class LOJAMOBLY_Resource_Cart_Item implements LOJAMOBLY_Resource_Cart_Item_Interface
{
    public $productId;
    public $name;
    public $price;
    ...
    public function __construct(LOJAMOBLY_Resource_Product_Item_Interface$product, $qty)
    {
