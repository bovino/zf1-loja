 ...
 */
class LOJAMOBLY_Resource_Product extends LOJAMOBLY_Model_Resource_Db_Table_Abstract implements LOJAMOBLY_Resource_Product_Interface 
{
    protected $_name    = 'product';
    protected $_primary  = 'productId';
    protected $_rowClass = 'LOJAMOBLY_Resource_Product_Item';
