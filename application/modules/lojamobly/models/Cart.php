 ...
 */
class LOJAMOBLY_Model_Cart extends LOJAMOBLY_Model_Abstract implements SeekableIterator, Countable, ArrayAccess
{
   /**
     ...
     *
     * @param LOJAMOBLY_Resource_Product_Item_Interface $product
     * @param int $qty
     * @return LOJAMOBLY_Resource_Cart_Item
     */
    public function addItem(LOJAMOBLY_Resource_Product_Item_Interface $product, $qty)
    {
        if (0 > $qty) {
            return false;
        }
        ...
        $item = new LOJAMOBLY_Resource_Cart_Item($product, $qty);   
     ...
     * 
     * @param int|LOJAMOBLY_Resource_Product_Item_Interface $product
     */
    ...
    public function seek($index)
    {
        ...
        if (!$this->valid()) {
            throw new LOJAMOBLY_Model_Exception('Posição "seek" inválida');
        }
    }
