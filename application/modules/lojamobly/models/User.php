 ...
 */
class LOJAMOBLY_Model_User extends LOJAMOBLY_Model_Acl_Abstract
{    
    /**
     * Get User by their id
     * 
     * @param  int $id
     * @return null|LOJAMOBLY_Resource_User_Item 
     */
     ...
     * @param  LOJAMOBLY_Resource_User_Item $ignoreUser User to ignore from the search
     * @return null|LOJAMOBLY_Resource_User_Item 
     */
     ...
     * Delete a user
     *
     * @param int|LOJAMOBLY_Resource_User_Item_Interface $user
     * @return boolean
     */
    public function deleteUser($user)
    {
        ...
        if ($user instanceof LOJAMOBLY_Resource_User_Item_Interface) {
    ...
    public function getAcl()
    {
        if (null === $this->_acl) {
			...
			$this->setAcl(new LOJAMOBLY_Model_Acl_Lojamobly());
        }
        return $this->_acl;
    }
