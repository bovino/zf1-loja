<?php
/**
 * LOJAMOBLY_Service_Authentication
 * 
 ...
 */
class LOJAMOBLY_Service_Authentication 
{
    /**
     ...
     * Construct 
     * 
     * @param null|LOJAMOBLY_Model_User $userModel 
     */
    public function __construct(LOJAMOBLY_Model_User $userModel = null)
    {
        $this->_userModel = null === $userModel ? new LOJAMOBLY_Model_User() : $userModel;
    }
