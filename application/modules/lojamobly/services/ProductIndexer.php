<?php
/**
 * LOJAMOBLY_Service_ProductIndexer
 *
 ...
 */
class LOJAMOBLY_Service_ProductIndexer
{
    /**
    ...
    public function getIndexingEngine()
    {
        if (null === $this->_engine) {
            ...
            if (null === $directory) {
                throw new LOJAMOBLY_Service_Indexer_Exception('Index directory must be set');
            }
     ...
     */
    public function indexProduct(LOJAMOBLY_Model_Document_Product $document)
    {
     ...
     * Delete a product
     * 
     * @param LOJAMOBLY_Model_Document_Product|int $documentOrId 
     */
    public function deleteProduct($documentOrId)
    {
        $id = $documentOrId;

        if ($documentOrId instanceof LOJAMOBLY_Model_Document_Product) {
     ...
     * 
     * @param LOJAMOBLY_Model_Catalog $catalogModel 
     */
    public function reIndexAllProducts(LOJAMOBLY_Model_Catalog $catalogModel)
    {
        ...
        if (null !== $products) {
            foreach ($products as $product) {
                ...
                $document = new LOJAMOBLY_Model_Document_Product($product, join(',', $categories));
