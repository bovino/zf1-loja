 ...
 */
class LOJAMOBLY_View_Helper_Cart extends Zend_View_Helper_Abstract
{
    public $cartModel;

    public function Cart()
    {
        $this->cartModel = new LOJAMOBLY_Model_Cart();
    ...
    public function addForm(LOJAMOBLY_Resource_Product_Item $product)
    {
    ...
    {
        $currency = new Zend_Currency();
        $shipping = new LOJAMOBLY_Model_Shipping();
