<?php
/**
 * LOJAMOBLY_View_Helper_ProductPrice
 * 
 ...
 */
class LOJAMOBLY_View_Helper_ProductPrice extends Zend_View_Helper_Abstract
{       
    public function productPrice(LOJAMOBLY_Resource_Product_Item $product)
    {
