 ...
 *
 * @category   Storefront
 * @package    LOJAEXEMPLOZF_Controller_Helper
 * @copyright  Copyright (c) 2008 Keith Pope (http://www.thepopeisdead.com)
 * @license    http://www.thepopeisdead.com/license.txt     New BSD License
 */
class LOJAEXEMPLOZF_Controller_Helper_Service extends Zend_Controller_Action_Helper_Abstract
{
    ...
    public function getService($service, $module)
    {
        if (!isset($this->_services[$module][$service])) {
            ...
            if (!class_exists($class)) {
                throw new LOJAEXEMPLOZF_Exception("Class $class não encontrada em " . basename($classPath));
            }
