 ...
 */
abstract class LOJAEXEMPLOZF_Model_Abstract implements LOJAEXEMPLOZF_Model_Interface
{
    /**
    ...
    */
    ...
    /**
     * @var LOJAEXEMPLOZF_Model_Cache_Abstract
     */
    protected $_cache;
    ...
    */
     ...
     *
     * @param string $name
     * @return LOJAEXEMPLOZF_Model_Resource_Interface
     */
     ...
     * 
     * @param LOJAEXEMPLOZF_Model_Cache_Abstract $cache
     */
    public function setCache(LOJAEXEMPLOZF_Model_Cache_Abstract $cache)
    {
        $this->_cache = $cache;
    }
     ...
     * @return LOJAEXEMPLOZF_Model_Cache_Abstract 
     */
    public function getCached($tagged = null)
    {
        if (null === $this->_cache) {
            $this->_cache = new LOJAEXEMPLOZF_Model_Cache($this, $this->getCacheOptions(), $tagged);
        }
