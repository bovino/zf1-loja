<?php
/**
 * LOJAEXEMPLOZF_Model_Resource_Db_Table_Abstract
 * 
 ...
 */
abstract class LOJAEXEMPLOZF_Model_Resource_Db_Table_Abstract extends Zend_Db_Table_Abstract implements LOJAEXEMPLOZF_Model_Resource_Db_Interface
{
	/**
