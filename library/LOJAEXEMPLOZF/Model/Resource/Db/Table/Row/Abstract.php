<?php
/**
 * LOJAEXEMPLOZF_Model_Resource_Db_Table_Row_Abstract
 * 
 ...
 */
abstract class LOJAEXEMPLOZF_Model_Resource_Db_Table_Row_Abstract
{
    /**
    ...
    public function setRow(array $config = array())
    {
        ...
        throw new LOJAEXEMPLOZF_Model_Exception('Could not set rowClass in ' . __CLASS__);
    }
