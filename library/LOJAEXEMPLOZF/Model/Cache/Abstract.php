<?php
/**
 * LOJAEXEMPLOZF_Model_Cache_Abstract
 *
 ...
 */
abstract class LOJAEXEMPLOZF_Model_Cache_Abstract
{
    /**
    ...
    /**
     * @var LOJAEXEMPLOZF_Model_Abstract
     */
    protected $_model;
     ...
     * Constructor 
     * 
     * @param LOJAEXEMPLOZF_Model_Abstract $model
     * @param array|Zend_Config $options 
     */
    public function __construct(LOJAEXEMPLOZF_Model_Abstract $model, $options, $tagged = null)
    {
        $this->_model = $model;
    ...
    */
    ...
    {
        if ('Class' != $frontend) {
            throw new LOJAEXEMPLOZF_Model_Exception('Frontend type must be Class');
        }
    ...
    public function __call($method, $params)
    {
        if (!is_callable(array($this->_model, $method))) {
            throw new LOJAEXEMPLOZF_Model_Exception('Method ' . $method . ' does not exist in class ' . get_class($this->_model) );
        }
        $cache = $this->getCache();
