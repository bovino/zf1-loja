 ...
 */
abstract class LOJAMOBLY_Model_Abstract implements LOJAMOBLY_Model_Interface
{
    /**
    ...
    */
    ...
    /**
     * @var LOJAMOBLY_Model_Cache_Abstract
     */
    protected $_cache;
    ...
    */
     ...
     *
     * @param string $name
     * @return LOJAMOBLY_Model_Resource_Interface
     */
     ...
     * 
     * @param LOJAMOBLY_Model_Cache_Abstract $cache
     */
    public function setCache(LOJAMOBLY_Model_Cache_Abstract $cache)
    {
        $this->_cache = $cache;
    }
     ...
     * @return LOJAMOBLY_Model_Cache_Abstract 
     */
    public function getCached($tagged = null)
    {
        if (null === $this->_cache) {
            $this->_cache = new LOJAMOBLY_Model_Cache($this, $this->getCacheOptions(), $tagged);
        }
