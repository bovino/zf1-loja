 ...
 */
abstract class LOJAMOBLY_Model_Acl_Abstract extends LOJAMOBLY_Model_Abstract implements LOJAMOBLY_Model_Acl_Interface, Zend_Acl_Resource_Interface
{
    /**
     * @var Zend_Acl
     */
    ...
    public function setIdentity($identity)
    {
        if (is_array($identity)) {
            ...
            throw new LOJAMOBLY_Model_Exception('Invalid identity provided');
        }
