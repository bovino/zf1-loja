<?php
/**
 * LOJAMOBLY_Model_Resource_Db_Table_Abstract
 * 
 ...
 */
abstract class LOJAMOBLY_Model_Resource_Db_Table_Abstract extends Zend_Db_Table_Abstract implements LOJAMOBLY_Model_Resource_Db_Interface
{
	/**
