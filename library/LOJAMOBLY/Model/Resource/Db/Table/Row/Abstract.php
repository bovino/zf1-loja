<?php
/**
 * LOJAMOBLY_Model_Resource_Db_Table_Row_Abstract
 * 
 ...
 */
abstract class LOJAMOBLY_Model_Resource_Db_Table_Row_Abstract
{
    /**
    ...
    public function setRow(array $config = array())
    {
        ...
        throw new LOJAMOBLY_Model_Exception('Could not set rowClass in ' . __CLASS__);
    }
