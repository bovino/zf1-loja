 ...
 */
class LOJAMOBLY_Controller_Helper_Service extends Zend_Controller_Action_Helper_Abstract
{
    ...
    public function getService($service, $module)
    {
        if (!isset($this->_services[$module][$service])) {
            ...
            if (!class_exists($class)) {
                throw new LOJAMOBLY_Exception("Class $class não encontrada em " . basename($classPath));
            }
